...
function selectBase($connexion)
{
   ...
   $ok=mysqli_query($query, $connexion); 
   return $ok;
}
...
function obtenirNbEtabOffrantChambres($connexion)
{
   ...
   $rsEtabOffrantChambres=mysqli_query($req, $connexion);
...
function existeAttributionsEtab($connexion, $id)
{
   ...
   $rsAttrib=mysqli_query($req, $connexion);
...
function obtenirNbOccup($connexion, $idEtab)
{
   ...
   $rsOccup=mysqli_query($req, $connexion);
...
function obtenirNbOccupGroupe($connexion, $idEtab, $idGroupe)
{
   ...
   $rsAttribGroupe=mysqli_query($req, $connexion);
   if ($lgAttribGroupe=mysqli_fetch_array($rsAttribGroupe))
